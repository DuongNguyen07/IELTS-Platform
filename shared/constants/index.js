...
export const DIFFICULTY_ORDER = { easy: 1, intermediate: 2, advanced: 3 };

// EXAM LIBRARY — Tests per page
export const TESTS_PER_PAGE = 8;

// EXAM LIBRARY — Mock test data
export const EXAM_LIBRARY_TESTS = [
  ...
  { id: 5,  title: 'General Training Test 08',      type: 'general',   durationMins: 60, difficulty: 'intermediate' },
  ...
  { id: 11, title: 'General Reading Test 03',       type: 'general',   durationMins: 60, difficulty: 'easy'         },
  ...
  { id: 16, title: 'General Training Test 12',      type: 'general',   durationMins: 60, difficulty: 'advanced'     },
];